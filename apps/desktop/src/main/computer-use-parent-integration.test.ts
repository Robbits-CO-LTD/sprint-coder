...
function controllerFor(binding: ComputerUseNativeBinding, enabled?: () => boolean) {
  ...
  const persistence: ComputerUseControllerPersistence = {
    ...
    setComputerAppGrantProviderEgress: unexpectedPersistence,
    removeComputerAppGrant: unexpectedPersistence,
    purgeUnauthenticatedComputerAppGrants: unexpectedPersistence,
    recordComputerAppAccessRequest: unexpectedPersistence,
    getComputerAppAccessRequest: unexpectedPersistence,
    countComputerAppAccessRequestsForTask: unexpectedPersistence,
    listComputerAppAccessRequestTotals: unexpectedPersistence,
