...
- 計画版: v2
- 状態: planning
- 現在地: Team Slice 0完了。Core A1-A4 execution/attempt persistence完了
- 正本: このディレクトリと配下のADR
...
- 現行DB migrationはv38。新規Claude／Codex Turn・Agentはbuilt-in connection IDと
...
- Slice 0のRoot Cause Confirmed Gateは完了した。Team unitは26 passed／1 skipped、
  ...
  だけをPlaywrightで検査する。
- 次はCore A5として、Worker direct message監査とTeam activity event projectionを実装する。
