...
## Current checkpoint: stored documents and visible differences
...
| AC-12      | Typed IR history, semantic/render revisions and IR difference UI are implemented. SourceRef snapshots/differences and persisted generation failure state remain.              |
